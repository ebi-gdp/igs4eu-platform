...
public interface UserConsentDetailsRepository extends R2dbcRepository<UserDPAConsentDetails, String> {
    Mono<UserDPAConsentDetails> findFirstByOrderByVersionDesc();
}
