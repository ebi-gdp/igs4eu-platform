...
public interface PipelineQueries {
    ...
    String FIND_BY_USER_ID_FULL_DETAILS_ORDER_BY_LIMIT = joinQuery(FIND_BY_USER_ID_FULL_DETAILS,
            ORDER_BY_LIMIT);

    String FIND_BY_USER_ID_FULL_DETAILS_PIPELINE_ID_CONDITION = joinQuery(FIND_BY_USER_ID_FULL_DETAILS,
            PIPELINE_ID_CONDITION);

    String FIND_BY_USER_ID_ORDER_BY_LIMIT_OFFSET = joinQuery(FIND_BY_USER_ID,
