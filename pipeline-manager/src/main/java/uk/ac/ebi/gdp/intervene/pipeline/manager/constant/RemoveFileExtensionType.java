...
public enum RemoveFileExtensionType {
    PGEN(".pgen"),
    PSAM(".psam"),
    PVAR(".pvar");
    ...
    RemoveFileExtensionType(final String fileExtension) {
    ...
    public static boolean containsFileExtension(final String fileExtensionToBeChecked) {
        for (final RemoveFileExtensionType fileExtensionType : RemoveFileExtensionType.values()) {
